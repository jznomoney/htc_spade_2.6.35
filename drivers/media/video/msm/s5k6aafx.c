...
static int s5k6aafx_set_sensor_mode(int mode)
{
	...
	case SENSOR_PREVIEW_MODE:
		...
		if (op_mode == SENSOR_PREVIEW_MODE)
			return 0;
...
static int s5k6aafx_set_wb(enum wb_mode wb_value)
{
	...
	case CAMERA_AWB_CLOUDY: /*cloudy*/
		...
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D0, 0x05D8);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D2, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D4, 0x0400);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D6, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D8, 0x04C0);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03DA, 0x0001);
		break;
	case CAMERA_AWB_INDOOR_HOME: /*Fluorescent*/
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x0400, 0x0077);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D0, 0x05A0);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D2, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D4, 0x0400);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D6, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D8, 0x07C0);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03DA, 0x0001);
		break;
	case CAMERA_AWB_INDOOR_OFFICE: /*Incandescent*/
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x0400, 0x0077);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D0, 0x0400);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D2, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D4, 0x03D4);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D6, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D8, 0x0900);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03DA, 0x0001);
		break;
	case CAMERA_AWB_SUNNY: /*outdoor*/
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x0400, 0x0077);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D0, 0x0790);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D2, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D4, 0x0400);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D6, 0x0001);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03D8, 0x0480);
		s5k6aafx_i2c_write(s5k6aafx_client->addr, 0x03DA, 0x0001);
		break;
	default:
		break;
